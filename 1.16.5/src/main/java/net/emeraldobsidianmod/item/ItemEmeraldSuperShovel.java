...
public class ItemEmeraldSuperShovel extends ElementsDerecsEmeraldObsidianModMod.ModElement {
	@GameRegistry.ObjectHolder("derecs_emerald__obsidian_mod:emerald_super_shovel")
	public static final Item block = null;
	public ItemEmeraldSuperShovel(ElementsDerecsEmeraldObsidianModMod instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("emerald_super_shovel").setRegistryName("emerald_super_shovel").setCreativeTab(CreativeTabs.TOOLS));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("derecs_emerald__obsidian_mod:emerald_super_shovel", "inventory"));
	}
