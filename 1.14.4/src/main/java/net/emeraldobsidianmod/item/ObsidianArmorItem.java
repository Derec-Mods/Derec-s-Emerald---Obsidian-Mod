...
public class ObsidianArmorItem extends DerecsEmeraldObsidianModModElements.ModElement {
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_armor_boots")
	public static final Item boots = null;
	public ObsidianArmorItem(DerecsEmeraldObsidianModModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "derecs_emerald__obsidian_mod:textures/models/armor/obsidian__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
