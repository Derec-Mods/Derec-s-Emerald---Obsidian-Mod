...
public class EmeraldSlasherItem extends DerecsEmeraldObsidianModModElements.ModElement {
	@ObjectHolder("derecs_emerald__obsidian_mod:emerald_slasher")
	public static final Item block = null;
	public EmeraldSlasherItem(DerecsEmeraldObsidianModModElements instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("A slower but more bulky blade!"));
			}
		}.setRegistryName("emerald_slasher"));
	}
