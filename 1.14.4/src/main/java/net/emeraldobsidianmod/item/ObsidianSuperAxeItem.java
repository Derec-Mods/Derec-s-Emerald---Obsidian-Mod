...
public class ObsidianSuperAxeItem extends DerecsEmeraldObsidianModModElements.ModElement {
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_super_axe")
	public static final Item block = null;
	public ObsidianSuperAxeItem(DerecsEmeraldObsidianModModElements instance) {
		super(instance, 32);
	}
	...
	public void initElements() {
		elements.items.add(() -> new AxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Realistic tree breaking... sorta"));
			}
		...
		}.setRegistryName("obsidian_super_axe"));
	}
}
