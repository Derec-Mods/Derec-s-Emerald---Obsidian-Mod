...
public class ObsidianShovelItem extends DerecsEmeraldObsidianModModElements.ModElement {
	@ObjectHolder("derecs_emerald__obsidian_mod:obsidian_shovel")
	public static final Item block = null;
	public ObsidianShovelItem(DerecsEmeraldObsidianModModElements instance) {
		super(instance, 28);
	}
