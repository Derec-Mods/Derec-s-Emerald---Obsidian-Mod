...
public class SuperPickNorthProcedure extends DerecsEmeraldObsidianModModElements.ModElement {
	public SuperPickNorthProcedure(DerecsEmeraldObsidianModModElements instance) {
		super(instance, 55);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency entity for procedure SuperPickNorth!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency itemstack for procedure SuperPickNorth!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency x for procedure SuperPickNorth!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency y for procedure SuperPickNorth!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency z for procedure SuperPickNorth!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DerecsEmeraldObsidianModMod.LOGGER.warn("Failed to load dependency world for procedure SuperPickNorth!");
			return;
		}
		...
		if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
			...
			if (((!((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) (z - 2)))).getBlock() == Blocks.OBSIDIAN.getDefaultState()
					...
					&& (!((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) (z - 2)))).getBlock() == Blocks.BEDROCK.getDefaultState()
							.getBlock())))) {
				if (world instanceof World) {
					Block.spawnDrops(world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) (z - 2))), (World) world,
							new BlockPos((int) (x - 1), (int) y, (int) (z - 2)));
		...
		if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
			...
			if (((!((world.getBlockState(new BlockPos((int) (x - 1), (int) (y - 1), (int) (z - 2)))).getBlock() == Blocks.OBSIDIAN.getDefaultState()
					...
					&& (!((world.getBlockState(new BlockPos((int) (x - 1), (int) (y - 1), (int) (z - 2)))).getBlock() == Blocks.BEDROCK
							.getDefaultState().getBlock())))) {
				if (world instanceof World) {
					Block.spawnDrops(world.getBlockState(new BlockPos((int) (x - 1), (int) (y - 1), (int) (z - 2))), (World) world,
							new BlockPos((int) (x - 1), (int) (y - 1), (int) (z - 2)));
					world.destroyBlock(new BlockPos((int) (x - 1), (int) (y - 1), (int) (z - 2)), false);
				}
				{
					ItemStack _ist = (itemstack);
					if (_ist.attemptDamageItem((int) 1, new Random(), null)) {
